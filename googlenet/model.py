...
class InceptionAux(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        self.conv = BasicCon2d(in_channels, 128, kernel_size=1)
...
class Inception(nn.Module):
    def __init__(self, in_channels, ch1x1, ch3x3red, ch3x3, ch5x5red, ch5x5, pool_proj):
        ...
        self.branch1 = BasicCon2d(in_channels, ch1x1, kernel_size=1)

        self.branch2 = nn.Sequential(
            BasicCon2d(in_channels, ch3x3red, kernel_size=1),
            BasicCon2d(ch3x3red, ch3x3, kernel_size=3, padding=1)
        )

        self.branch3 = nn.Sequential(
            BasicCon2d(in_channels, ch5x5red, kernel_size=1),
            BasicCon2d(ch5x5red, ch5x5, kernel_size=5, padding=2)
        )

        self.branch4 = nn.Sequential(
            nn.MaxPool2d(kernel_size=3, stride=1, padding=1),
            BasicCon2d(in_channels, pool_proj, kernel_size=1)
        )
